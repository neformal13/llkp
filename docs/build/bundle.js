...
var _llkp = __webpack_require__(0);

__webpack_require__(6);

var zipCode = (0, _llkp.ABNF)('5DIGIT ["-" 4DIGIT]');
var state = (0, _llkp.ABNF)('2ALPHA');
var townName = (0, _llkp.ABNF)('1*(ALPHA / SP)');
var zipPart = (0, _llkp.ABNF)('townName "," SP state 1*2SP zipCode [LF]', {
    townName: townName,
    state: state,
    zipCode: zipCode
});

var streetName = (0, _llkp.ABNF)('1*VCHAR');
var houseNum = (0, _llkp.ABNF)('1*8(DIGIT / ALPHA)');
var apt = (0, _llkp.ABNF)('1*4DIGIT');
var street = (0, _llkp.ABNF)('[apt SP] houseNum SP streetName LF', {
    apt: apt,
    houseNum: houseNum,
    streetName: streetName
});
var suffix = (0, _llkp.ABNF)('("Jr." / "Sr." / 1*("I" / "V" / "X"))');
var lastName = (0, _llkp.ABNF)('*ALPHA');
var initial = (0, _llkp.ABNF)('ALPHA');
var firstName = (0, _llkp.ABNF)('*ALPHA');
var personalPart = (0, _llkp.ABNF)('firstName / (initial ".")', { firstName: firstName, initial: initial });
var namePart = (0, _llkp.ABNF)('(*(personalPart SP) lastName [SP suffix] LF) / (personalPart LF)', { personalPart: personalPart, lastName: lastName, suffix: suffix });
var postalAddress = (0, _llkp.ABNF)('namePart street zipPart', { zipPart: zipPart, street: street, namePart: namePart });
...
document.forms[0].addEventListener("submit", function (ev) {
    ...
    var text = form.elements["input"].value;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js?importLoaders=1!./../../node_modules/postcss-loader/index.js!./input.css", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js?importLoaders=1!./../../node_modules/postcss-loader/index.js!./input.css");
